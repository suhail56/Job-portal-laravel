...
<body>
  <div class="main">
    <p class="sign" align="center">Login Employer</p>
    <form class="form1" action="los" method="post" enctype="multipart/form-data">
    @csrf 
      ...
      <p class="forgot" align="center"><a href="pregister">Register</p> 
